...
ColumnLayout {
        ...
        GridLayout {
            ...
            Repeater {
                ...
                Button {
                    ...
                    readonly property int wsId: Math.floor((Niri.activeWsId - 1) / 10) * 10 + index + 1
                    ...
                    function onClicked(): void {
                        // Niri doesn't support moving specific windows by address
                        // This will move the focused window
    ...
    RowLayout {
        ...
        // Note: Niri has limited window management commands compared to Hyprland
        // Features like pin, toggle floating are not directly available
