...
Item {
    ...
    // Click-away detection (replaces HyprlandFocusGrab)
    // Clicking outside the popout will close it via the Drawers.qml focusGrab
    // The escape key handler above also provides a way to close
